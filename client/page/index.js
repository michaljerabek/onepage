...
module.exports = Ractive.extend({
    ...
    components: {
        ...
        PageSectionClaim: require("./Components/PageSection/Types/PageSectionClaim"),
        PageSectionFactsIcons: require("./Components/PageSection/Types/PageSectionFactsIcons"),
        PageSectionFactsNumbers: require("./Components/PageSection/Types/PageSectionFactsNumbers"),
        PageSectionServices: require("./Components/PageSection/Types/PageSectionServices"),
        PageSectionEmail: require("./Components/PageSection/Types/PageSectionEmail"),
    ...
    partials: {
        ...
        PageSectionClaim: "<PageSectionClaim section='{{this}}' lang='{{~/page.lang}}' tplLang='{{~/page.tplLang}}' />",
        PageSectionFactsIcons: "<PageSectionFactsIcons section='{{this}}' lang='{{~/page.lang}}' tplLang='{{~/page.tplLang}}' />",
        PageSectionFactsNumbers: "<PageSectionFactsNumbers section='{{this}}' lang='{{~/page.lang}}' tplLang='{{~/page.tplLang}}' />",
        PageSectionServices: "<PageSectionServices section='{{this}}' lang='{{~/page.lang}}' tplLang='{{~/page.tplLang}}' />",
        PageSectionEmail: "<PageSectionEmail section='{{this}}' lang='{{~/page.lang}}' tplLang='{{~/page.tplLang}}' />",
