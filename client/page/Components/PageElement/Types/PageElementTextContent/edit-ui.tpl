...
{{#if .openPageElementSettings === 'edit1'}}
    ...
    >
        <div decorator="PageElementSettingsBox" data-min-resize-width="475" data-max-resize-width="475" data-max-resize-height="475" style="max-width: 240px; max-height: 320px;">
